        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center mb-4">
              <span className="text-2xl font-bold text-blue-400">Bissau</span>
              <span className="text-2xl font-bold text-white">Market</span>
            </div>
            <p className="text-gray-400 mb-4">
              A maior plataforma de classificados da Guiné-Bissau. Compre, venda e
              anuncie produtos e serviços de forma simples e segura.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/anuncios" className="text-gray-400 hover:text-white">
                  Todos os Anúncios
                </Link>
              </li>
              <li>
