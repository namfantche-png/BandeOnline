...
export declare class AdminController {
    ...
    blockUser(admin: any, blockUserDto: BlockUserDto): Promise<{
        message: string;
        user: {
            password: undefined;
            id: string;
    ...
    unblockUser(admin: any, userId: string): Promise<{
        message: string;
        user: {
            password: undefined;
            id: string;
    ...
    verifyUser(admin: any, userId: string): Promise<{
        message: string;
        user: {
            password: undefined;
            id: string;
    ...
    changeUserPlan(admin: any, userId: string, changeUserPlanDto: any): Promise<{
        message: string;
        subscription: {
            plan: {
                id: string;
    ...
    moderateAd(admin: any, moderateAdDto: ModerateAdDto): Promise<{
        message: string;
        ad: {
            id: string;
            userId: string;
    ...
    removeAd(admin: any, adId: string, reason: string): Promise<{
        message: string;
        ad: {
            id: string;
            userId: string;
    ...
    createCategory(admin: any, categoryDto: AdminCategoryDto): Promise<{
        id: string;
        description: string | null;
        createdAt: Date;
        updatedAt: Date;
    ...
    updateCategory(admin: any, categoryId: string, categoryDto: AdminCategoryDto): Promise<{
        id: string;
        description: string | null;
        createdAt: Date;
        updatedAt: Date;
    ...
    deleteCategory(admin: any, categoryId: string): Promise<{
        message: string;
    }>;
    getAllPlans(): Promise<({
        _count: {
    ...
    createPlan(admin: any, planDto: AdminPlanDto): Promise<{
        id: string;
        description: string | null;
        price: number;
        currency: string;
    ...
    updatePlan(admin: any, planId: string, planDto: AdminPlanDto): Promise<{
        id: string;
        description: string | null;
        price: number;
        currency: string;
    ...
    deactivatePlan(admin: any, planId: string): Promise<{
        id: string;
        description: string | null;
        price: number;
        currency: string;
    ...
    resolveReport(admin: any, reportId: string, resolution: string, action: 'approve' | 'dismiss'): Promise<{
        message: string;
        report: {
            id: string;
            description: string | null;
